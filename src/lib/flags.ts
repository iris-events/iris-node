...
const IRIS_DISABLE_MESSAGE_CONSUME_VALIDATION = 'DISABLE_MESSAGE_CONSUME_VALIDATION'
const IRIS_DISABLE_MESSAGE_PRODUCE_VALIDATION = 'DISABLE_MESSAGE_PRODUCE_VALIDATION'

// only for internal use during tests
let ALLOW_USING_RESERVED_NAMES: boolean = false
...
const flags = {
  ...
  get DISABLE_MESSAGE_CONSUME_VALIDATION(): boolean {
    return helper.isEnvTrue(process.env[IRIS_DISABLE_MESSAGE_CONSUME_VALIDATION])
  },
  set DISABLE_MESSAGE_CONSUME_VALIDATION(flag: boolean) {
    process.env[IRIS_DISABLE_MESSAGE_CONSUME_VALIDATION] = helper.getEnvBoolFlag(flag)
  },
  get DISABLE_MESSAGE_PRODUCE_VALIDATION(): boolean {
    return helper.isEnvTrue(process.env[IRIS_DISABLE_MESSAGE_PRODUCE_VALIDATION])
  },
  set DISABLE_MESSAGE_PRODUCE_VALIDATION(flag: boolean) {
    process.env[IRIS_DISABLE_MESSAGE_PRODUCE_VALIDATION] = helper.getEnvBoolFlag(flag)
  },
