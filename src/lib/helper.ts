...
export function classIsSameOrSubclassOf(
	classToCheck: Function,
	classToCompareTo: Function,
): boolean {
	return (
		classToCheck === classToCompareTo ||
		classToCheck.prototype instanceof classToCompareTo
	);
}
